...
ActiveRecord::Schema.define(version: 2021_07_19_001454) do
  ...
  create_table "archery_lesson_appointments", force: :cascade do |t|
    t.bigint "product_id"
    t.datetime "start_time", null: false
    t.datetime "end_time", null: false
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["product_id"], name: "index_archery_lesson_appointments_on_product_id"
  end
